...
(function () {
  ...
  var MILESTONES = [
    { minutes: 5,  key: 'fb_5',  prompt: 'Quick gut check - what\'s your first impression?' },
    { minutes: 15, key: 'fb_15', prompt: 'You\'ve been at this a bit. Anything confusing, missing, or annoying so far?' },
    { minutes: 60, key: 'fb_60', prompt: 'Last one, promise. What would make you actually keep using this?' }
  ];
